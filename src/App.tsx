...
function GithubIcon({ size = 16, color = "currentColor" }: { size?: number; color?: string }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill={color} aria-hidden="true">
      <path d="M12 .5C5.73.5.5 5.73.5 12c0 5.08 3.29 9.39 7.86 10.91.58.1.79-.25.79-.56 0-.27-.01-1.17-.02-2.12-3.2.7-3.88-1.36-3.88-1.36-.52-1.33-1.28-1.69-1.28-1.69-1.04-.71.08-.7.08-.7 1.16.08 1.77 1.19 1.77 1.19 1.02 1.75 2.68 1.25 3.34.95.1-.74.4-1.25.72-1.54-2.56-.29-5.25-1.28-5.25-5.7 0-1.26.45-2.29 1.19-3.09-.12-.29-.52-1.47.11-3.06 0 0 .97-.31 3.18 1.18a11 11 0 0 1 5.79 0c2.2-1.49 3.17-1.18 3.17-1.18.63 1.59.24 2.77.12 3.06.74.8 1.19 1.83 1.19 3.09 0 4.43-2.69 5.41-5.26 5.69.41.36.78 1.06.78 2.14 0 1.55-.01 2.79-.01 3.17 0 .31.21.67.8.56A10.51 10.51 0 0 0 23.5 12C23.5 5.73 18.27.5 12 .5Z"/>
    </svg>
  );
}
...
function CloudCertIcon({ size = 14, color = "currentColor" }: { size?: number; color?: string }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      <path d="M7 18a4.5 4.5 0 0 1-.4-8.98A5.5 5.5 0 0 1 17.2 8.1 4 4 0 0 1 17 16H7Z" />
    </svg>
  );
}
          ...
          <div className="mt-10">
            ...
            <div className="flex flex-wrap gap-2">
              {CERTIFICATIONS.map((c) => (
                ...
                >
                  <CloudCertIcon size={14} color={ACCENT} />
                  {c}
                </span>
              ))}
            </div>
    ...
    <section id="contact" className="py-24 px-6 max-w-5xl mx-auto"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
        ...
        <div className="flex flex-col gap-3">
          {[
            { label: "GitHub", val: "github.com/VasundhraBatra", href: "https://github.com/VasundhraBatra?tab=repositories", Icon: GithubIcon },
            { label: "LinkedIn", val: "linkedin.com/in/vasu-batra", href: "https://www.linkedin.com/in/vasu-batra/", Icon: LinkedinIcon },
            ...
            >
              <span className="flex items-center gap-2 text-xs uppercase tracking-widest" style={{ color: MUTED }}>
